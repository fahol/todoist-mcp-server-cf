// Generated by Wrangler by running `wrangler types` (hash: 3b7b40a43dee2091a3af78a43507d188)
// Runtime types generated with workerd@1.20250408.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		TODOIST_CLIENT_ID: string;
		TODOIST_CLIENT_SECRET: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").TodoistMCP>;
		AI: Ai;
	}
}
